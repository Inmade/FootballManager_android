...
public class CustomListAdapterReception extends ArrayAdapter<String> {
    ...
    public CustomListAdapterReception(Activity context, String[] mail_destinataire, String[] titre, String[] corps) {
